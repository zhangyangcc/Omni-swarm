...
def write_dis(output,time,distance):
    if(len(time)!=len(distance)):
        raise SystemExit('!!!!!!! in function wrtire_dis, invalid input!!!!!!!')
...
def construct_swarm(ts,pose,quat,velocity,distance,vo_avail,dis_avail):
    '''
    the dimension of pose , quat, velocity, distance must be 3
    quat = [x y z w]
    distance should be one demension
        ...
        if(dis_avail):
            for j in range(len(pose)):
                if(j != i):
                    ...
                    _nf.dismap_dists.append(distance)
...
def generate_dis_noise(distance):
    ...
    '''
    dis_noise = 0.05
    dis_out = distance+np.random.randn()*dis_noise
...
if __name__ == "__main__":
    ...
    # write_poses("/home/zy/ros_ws/euroc_dataset/ground_truth_tum/vo1_sync.txt",vo1_time,vo1_pose,vo1_quat)
    # write_poses("/home/zy/ros_ws/euroc_dataset/ground_truth_tum/vo2_sync.txt",vo2_time,vo2_pose,vo2_quat)

    print("length of vo1_time is %d" %len(vo1_time))
    print("length of vo2_time is %d" %len(vo2_time))
    print("----------------------------------")
...
# sync vo data by function get_vo()
    ...
    print("length of vo1_time is %d" %len(vo1_time))
    print("length of vo2_available is %d" %len(vo2_available))
    ...
    # write_poses("/home/zy/ros_ws/euroc_dataset/ground_truth_tum/truth1_sync.txt",vo1_time,truth1_pose_sync,truth1_quat_sync)
    # write_poses("/home/zy/ros_ws/euroc_dataset/ground_truth_tum/truth2_sync.txt",vo1_time,truth2_pose_sync,truth2_quat_sync)
    ...
    write_dis("/home/zy/ros_ws/euroc_dataset/ground_truth_tum/distance.txt",vo1_time,distance12)
    
    print("length of distance12 is %d" %len(distance12))
    print("length of distance12_avail is %d" %len(dis12_available))
    print("----------------------------------")
